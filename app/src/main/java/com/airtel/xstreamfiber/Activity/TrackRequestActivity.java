...
public class TrackRequestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String pageUrl= "https://www.airtel.in/track-order";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtToolbarTitle.setText("Track Request");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        TrackRequestActivity.this.overridePendingTransition(R.anim.fade, R.anim.fadeout);
    }
}
